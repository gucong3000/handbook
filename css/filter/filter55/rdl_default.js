...
var arrMenuBarItems = new Array(
    ...
    new Array('样式表滤镜中文手册 ', 'index.htm', sDefaultItemCode),
    new Array('︱', '', 'return false;'),
...
var arrMenus1 = new Array(
    new Array('集合  Collections', 'rdl_collections.html', '', 'border'),
    new Array('滤镜  Filters', 'submenu', 'window.location="rdl_filters.html";return false;', ''),
    new Array('方法  Methods', 'rdl_methods.html', '', ''),
    new Array('特性  Properties', 'rdl_properties.html', '', ''),
    new Array('属性  Attributes', 'rdl_attributes.html', '', ''),
    new Array('事件  Events', 'rdl_events.html', '', '')
);

var arrMenus11 = new Array(
    new Array('界面滤镜  Procedural Surfaces', 'rdl_surfaces.html', '', 'border'),
    new Array('静态滤镜  Static Filters', 'rdl_static.html', '', ''),
    new Array('转换滤镜  Transitions', 'rdl_transitions.html', '', '')
);
...
function createMenu(sValue, arrItems, iWidth) {
    ...
    for (i = 0; i < arrItems.length; i++) {
        var oTempA = document.createElement("div");
